...
Claude Code に Tesla API のデータ収集スクリプトを書いてもらったら、ポーリング間隔の設計をミスって**無料枠（月$10）を一晩で溶かされた。**

「30秒間隔で2プロセス回せばリアルタイムですね！」じゃないんだよ。
...
怒りの勢いで Fleet Telemetry に移行したら、同じデータが **1,500倍安く** 取れるようになった。
